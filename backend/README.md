# Moodclip Shopify App

> **Note**: This file now lives inside the `moodclip-fullstack/backend` workspace. The full-stack mono-repo structure and extension integration details are documented in `../README.md`.
